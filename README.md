...
1. Prometheus Installation 
    ...
    4. Link for the user data: https://github.com/tdolivierth7/monitoring-prometheus-grafana/blob/main/prometheus-setup.sh
2. Launch web servers
    ...
    4. Link for the user data: https://github.com/tdolivierth7/monitoring-prometheus-grafana/blob/main/ecommerce-web-app.sh
3. Grafana Installation
    ...
    4. Link for the user data: https://github.com/tdolivierth7/monitoring-prometheus-grafana/blob/main/grafana-setup.sh

** To run the Python code to push the run time app logs to prometheus pushgateway **
```
git clone https://github.com/tdolivierth7/monitoring-prometheus-grafana.git
